...
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 \
	...
	--custom_cropping_flag True --decay_logan True --feature_matching_loss True  --logan_flag True  --wandb_flag True\
	...
	--name_experiment "[Inference mode Stylegan-V1-precipitation_normalized_with_0.008]"
