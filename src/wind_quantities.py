...
Reference URL : https://github.com/DamienIrving/climate-analysis/blob/master/data_processing/calc_wind_quantities.py
...
def axis_letters(dim_list):
    ...
    letter_list = []
    for dim in dim_list:
        assert dim in list(dim_letters.keys())
...
"""
    ...
    parser.add_argument("--region", type=str, choices=list(gio.regions.keys()),
