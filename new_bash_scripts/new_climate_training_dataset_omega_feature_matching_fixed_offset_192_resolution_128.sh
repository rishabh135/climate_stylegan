...
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 \
	...
	--name_experiment "[Stylegan V1 with new dataset training with feature matching without logan optimization] normalized_climate data at 128 new_version dataset"
