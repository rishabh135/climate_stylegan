...
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 \
	...
	--name_experiment "[SGAN1 Normalized_fixed_offset_feature matching step-annealed logan Omega 128 with custom cropping] wo_norm_climate data at 128 new_version"
