...
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 \
	...
	--test_num 50 --inference_counter_number 61250 --phase test \
	...
	--name_experiment "[Inference : fixed_offset_ Feature matching step-annealed logan Omega 128 with custom cropping] wo_norm_climate data at 128 new_version"
