...
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 \
	...
	--img_size 512 --gpu_num 4 --progressive False --phase train  --fixed_offset -1 \
	...
	--name_experiment "[Stylegan-V1_training_omega_resolution_512_logan_feature_matching_without_normalization]"
