...
python  /global/cscratch1/sd/rgupta2/backup/StyleGAN/src/StyleGAN-Tensorflow/main.py --dataset rbc_500 --input_channels 2 --start_res 8 \
	...
	--checkpoint_dir ../stored_outputs/rbc_working/checkpoint --result_dir ../stored_outputs/rbc_working/result \
	--log_dir ../stored_outputs/rbc_working/log --sample_dir ../stored_outputs/rbc_working/sample  
