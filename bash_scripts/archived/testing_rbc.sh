...
python  /global/cscratch1/sd/rgupta2/backup/StyleGAN/src/StyleGAN-Tensorflow/main.py --dataset rbc_500_testing --input_channels 2 --start_res 8 \
	--img_size 256 --gpu_num 4 --progressive True --phase test \
