...
python  /global/cscratch1/sd/rgupta2/backup/StyleGAN/src/StyleGAN-Tensorflow/main.py --dataset rbc_3500 --input_channels 2 \
	...
	--checkpoint_dir ../stored_outputs/radam_one_seventh_divergence/checkpoint --result_dir ../stored_outputs/radam_one_seventh_divergence/result \
	--log_dir ../stored_outputs/radam_one_seventh_divergence/log --sample_dir ../stored_outputs/radam_one_seventh_divergence/sample \
	--name_experiment "radam one_seventh with divergence_loss time_frame starts at 3500"
