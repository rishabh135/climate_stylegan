...
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 --input_channels 7 --start_res 8 \
	...
	--checkpoint_dir ./stored_outputs/seven_channel_climate_data/checkpoint --result_dir ./stored_outputs/seven_channel_climate_data/result \
	--log_dir ./stored_outputs/seven_channel_climate_data/log --sample_dir ./stored_outputs/seven_channel_climate_data/sample \
	--dataset_location /global/cscratch1/sd/rgupta2/backup/climate_stylegan/dataset/climate_data_seven_channels_by_year \
	--name_experiment "seven_channel_climate_data at 256 resolution"
