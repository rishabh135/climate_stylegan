...
#run the application:
python  /global/cscratch1/sd/rgupta2/backup/climate_stylegan/src/main.py --dataset climate_stylegan2900 --input_channels 1 --start_res 8 --test_num 50 --inference_counter_number 163593 \
	--img_size 128 --gpu_num 1 --progressive True --phase test --batch_size 1\
	...
	--name_experiment "[Inferenrce  UX 163593]_Brand new Ux alone 128 without normalization on a single channel"
